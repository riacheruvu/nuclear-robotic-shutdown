...
def load_scenario(
    ...
    cfg = ScenarioConfig(
        ...
        reachability_mode=str(reach.get("mode", "receding")),
        receding_window=int(reach.get("receding_window", 20)),
        compare_open_loop=bool(reach.get("compare_open_loop", True)),
        blowup_growth_threshold=float(reach.get("blowup_growth_threshold", 50.0)),
